/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c4ec40b5d3299a1fea620629f0498cc)
// Runtime types generated with workerd@1.20251210.0 2025-05-06 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NELCHAN_API_KEY: string;
		DISCORD_BOT_TOKEN: string;
		DISCORD_BOT_ID: string;
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		NelchanAgent: DurableObjectNamespace<import("./src/index").NelchanAgent>;
		nelchan_db: D1Database;
		VECTORIZE: VectorizeIndex;
		YUKI_SERVICE: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_KEY" | "NELCHAN_API_KEY" | "DISCORD_BOT_TOKEN" | "DISCORD_BOT_ID">> {}
}
